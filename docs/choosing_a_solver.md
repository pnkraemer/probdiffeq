...
a `ivpsolvers.strategy_smoother_fixedinterval` strategy for `solve_adaptive_save_every_step`,
and a `ivpsolvers.strategy_smoother_fixedpoint` strategy for `solve_adaptive_save_at`.
