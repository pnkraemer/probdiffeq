...
class _BlockDiagStatisticalFirstOrder(_corr.Correction):
    ...
    def begin(self, extrapolated, corr, /, vector_field, t, p):
        ...
        return extrapolated, corr

    def complete(self, extrapolated, corr, vector_field, t, p):
        vmap_f = jax.vmap(jax.tree_util.Partial(vector_field, t=t, p=p))
        ...
        return fn(self._mm, H, extrapolated, corr, noise)
...
class _BlockDiag(_corr.Correction):
    ...
    def begin(self, x, c, /, vector_field, t, p):
    ...
    def complete(self, extrapolated, corr, /, vector_field, t, p):
        ...
        return fn(self.corr, extrapolated, corr, vector_field, t, p)
